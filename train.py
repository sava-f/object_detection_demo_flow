...
subprocess.call("python xml_to_csv.py -i data/images/train -o data/annotations/train_labels.csv -l data/annotations", shell=True)
# Convert test folder annotation xml files to a single csv.
subprocess.call("python xml_to_csv.py -i data/images/test -o data/annotations/test_labels.csv", shell=True)
